    ...
    def forward(
        ...
        for batch in range(b):
            ...
            color = render_cuda(
                ...
                repeat(gaussian.means, "g xyz -> v g xyz", v=v),
                repeat(gaussian.covariances, "g i j -> v g i j", v=v),
                repeat(gaussian.harmonics, "g c d_sh -> v g c d_sh", v=v),
                repeat(gaussian.opacities, "g -> v g", v=v),
            )
            colors.append(color)
